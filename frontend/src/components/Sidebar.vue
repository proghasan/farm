  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        label: 'Pregnancies',
        path: '/pregnancies',
        icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="m11.25 20.25 8.25-8.25m-8.25 8.25L3 12m8.25 8.25V3" /></svg>`,
      },
    ],
  },
  {
