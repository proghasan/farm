...
type AnimalPregnancy struct {
	...
	ActualBirthDate     *string         `gorm:"type:date" json:"actual_birth_date,omitempty"`
	...
	NumberOfMaleChildren   *int          `json:"number_of_male_children,omitempty"`
	NumberOfFemaleChildren *int          `json:"number_of_female_children,omitempty"`
	NumberOfDeadChildren   *int          `json:"number_of_dead_children,omitempty"`
	...
	Breeder *Animal `gorm:"foreignKey:BreederID" json:"breeder,omitempty"`
}